...
func (in *ServiceBindingStatus) DeepCopyInto(out *ServiceBindingStatus) {
	*out = *in
	...
	if in.AsyncBindFailed != nil {
		in, out := &in.AsyncBindFailed, &out.AsyncBindFailed
		*out = new(bool)
		**out = **in
	}
}
...
func (in *ServiceInstanceStatus) DeepCopyInto(out *ServiceInstanceStatus) {
	*out = *in
	...
	if in.AsyncProvisionFailed != nil {
		in, out := &in.AsyncProvisionFailed, &out.AsyncProvisionFailed
		*out = new(bool)
		**out = **in
	}
}
