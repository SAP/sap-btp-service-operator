...
var _ = Describe("ServiceInstance controller", func() {
	...
	var serviceInstance *v1alpha.ServiceInstance
	var fakeInstanceName string
	var ctx context.Context
	var defaultLookupKey types.NamespacedName
	instanceSpec := v1alpha.ServiceInstanceSpec{
		...
		ParametersFrom: []v1alpha.ParametersFromSource{
			{
				SecretKeyRef: &v1alpha.SecretKeyReference{
					Name: "param-secret",
	...
	createInstance := func(ctx context.Context, instanceSpec v1alpha.ServiceInstanceSpec) *v1alpha.ServiceInstance {
		...
		createdInstance := &v1alpha.ServiceInstance{}
	...
	deleteInstance := func(ctx context.Context, instanceToDelete *v1alpha.ServiceInstance, wait bool) {
		err := k8sClient.Get(ctx, types.NamespacedName{Name: instanceToDelete.Name, Namespace: instanceToDelete.Namespace}, &v1alpha.ServiceInstance{})
		if err != nil {
	...
	updateInstance := func(ctx context.Context, serviceInstance *v1alpha.ServiceInstance) *v1alpha.ServiceInstance {
		isConditionRefersUpdateOp := func(instance *v1alpha.ServiceInstance) bool {
		...
		updatedInstance := &v1alpha.ServiceInstance{}
	...
	Describe("Create", func() {
		Context("Invalid parameters", func() {
			createInstanceWithFailure := func(spec v1alpha.ServiceInstanceSpec) {
				instance := &v1alpha.ServiceInstance{
					TypeMeta: metav1.TypeMeta{
						APIVersion: "services.cloud.sap.com/v1alpha1",
						Kind:       "ServiceInstance",
			...
			Describe("service plan id not provided", func() {
				When("service offering name and service plan name are not provided", func() {
					It("provisioning should fail", func() {
						createInstanceWithFailure(v1alpha.ServiceInstanceSpec{})
					})
				})
				When("service offering name is provided and service plan name is not provided", func() {
					It("provisioning should fail", func() {
						createInstanceWithFailure(v1alpha.ServiceInstanceSpec{ServiceOfferingName: "fake-offering"})
					})
				})
				When("service offering name not provided and service plan name is provided", func() {
					It("provisioning should fail", func() {
						createInstanceWithFailure(v1alpha.ServiceInstanceSpec{ServicePlanID: "fake-plan"})
					})
				})
			})
			...
			Describe("service plan id is provided", func() {
				When("service offering name and service plan name are not provided", func() {
					It("provision should fail", func() {
						createInstanceWithFailure(v1alpha.ServiceInstanceSpec{ServicePlanID: "fake-plan-id"})
					})
				})
		...
		When("external name is not provided", func() {
			It("succeeds and uses the k8s name as external name", func() {
				withoutExternal := v1alpha.ServiceInstanceSpec{
	...
	Describe("Update", func() {
		...
		updateSpec := func() v1alpha.ServiceInstanceSpec {
			newExternalName := "my-new-external-name" + uuid.New().String()
			return v1alpha.ServiceInstanceSpec{
