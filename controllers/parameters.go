...
func fetchParametersFromSource(kubeClient client.Client, namespace string, parametersFrom *v1alpha1.ParametersFromSource) (map[string]interface{}, error) {
...
func fetchSecretKeyValue(kubeClient client.Client, namespace string, secretKeyRef *v1alpha1.SecretKeyReference) ([]byte, error) {
