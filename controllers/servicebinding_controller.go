...
func (r *ServiceBindingReconciler) resyncBindingStatus(k8sBinding *v1.ServiceBinding, smBinding *smclientTypes.ServiceBinding, serviceInstanceID string) {
	if smBinding.Ready {
...
func (r *ServiceBindingReconciler) removeBindingFromKubernetes(ctx context.Context, serviceBinding *v1.ServiceBinding) (ctrl.Result, error) {
...
func (r *ServiceBindingReconciler) handleSecretError(ctx context.Context, op smTypes.OperationCategory, err error, binding *v1.ServiceBinding) (ctrl.Result, error) {
	log := GetLogger(ctx)
...
func (r *ServiceBindingReconciler) addInstanceInfo(ctx context.Context, binding *v1.ServiceBinding, credentialsMap map[string][]byte) error {
...
func (r *ServiceBindingReconciler) rotateCredentials(ctx context.Context, smClient sm.Client, binding *v1.ServiceBinding) error {
...
func (r *ServiceBindingReconciler) credRotationEnabled(binding *v1.ServiceBinding) bool {
	return binding.Spec.CredRotationPolicy != nil && binding.Spec.CredRotationPolicy.Enabled
}

func (r *ServiceBindingReconciler) initCredRotationIfRequired(binding *v1.ServiceBinding) bool {
...
func (r *ServiceBindingReconciler) recoverSecret(ctx context.Context, binding *v1.ServiceBinding, secret *corev1.Secret) error {
	log := GetLogger(ctx)
...
func (r *ServiceBindingReconciler) isStaleServiceBinding(binding *v1.ServiceBinding) bool {
