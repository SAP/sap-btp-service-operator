...
You can configure the SAP BTP service operator to work with multiple subaccounts in the same Kubernetes cluster. This means that different namespaces can be connected to different subaccounts.
