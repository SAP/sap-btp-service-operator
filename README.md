...
## Table of Contents
- [SAP Business Technology Platform (SAP BTP) Service Operator for Kubernetes](#sap-business-technology-platform-sap-btp-service-operator-for-kubernetes)
  - [Note](#note)
  - [Table of Contents](#table-of-contents)
  - [Prerequisites](#prerequisites)
  - [Setup](#setup)
  - [Using the SAP BTP Service Operator](#using-the-sap-btp-service-operator)
      - [Step 1: Create a service instance](#step-1-create-a-service-instance)
      - [Step 2: Create a Service Binding](#step-2-create-a-service-binding)
  ...
  - [SAP BTP kubectl Plugin (Experimental)](#sap-btp-kubectl-plugin-experimental)
...
| customTags | `[]string` | List of custom tags to append to the `.Status.Tags` field. |
